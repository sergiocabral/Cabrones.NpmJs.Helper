import { HelperCryptography } from '../../ts';
  ...
  describe('sha256', () => {
    test('o hash de saída deve ser o esperado', () => {
      ...
      for (const valueHash of Object.entries(wellKnownSha256)) {
        ...
        const calculatedHash = HelperCryptography.hashSha256(valueHash[0]);
    ...
    test('sha256 só recebe como entrada ASCII', () => {
      ...
      const invalidCall = () => HelperCryptography.hashSha256(nonAsciiValue);
